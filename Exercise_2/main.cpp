#include <iostream>
#include <fstream>
#include <streambuf> // Per poter stampare i risultati sul file e sullo schermo.
#include <string>
#include <sstream>
#include <iomanip>
#include "Utils.hpp"
...
int main()
{
  ...
  while(getline(input_file,line) && rows < size_row)
  {
      ...
      // Leggo la riga estratta e riempio la matrice, escludendo i valori letterali.
  ...
  // Stampo i risultati su schermo e sul file.
  print_vec(data, of);
  of << endl;
